...
@ASTRO@
오늘 별자리와 수비학 기운이 주는 금전적 힌트를 2문장으로 짚어라. 거래, 기회가 들어오는 수가 있다면 그것에 대해 3문장으로 알려줘라.
@SUMMARY@
오늘 당장 돈을 지키기 위해 '절대 하지 말아야 할 행동' 1가지와 운을 올리기 위한 색상/방향을 단호하게 선언하라. (5문장 내외)
"""
...
@SCORE@
해당 날짜의 금전 기운 점수를 0~100 사이의 숫자로만 적어라. (예: 45)
...
@SUMMARY@
이날 돈을 지키기 위해 '절대 하지 말아야 할 행동' 3가지와 운을 올리기 위한 색상/방향을 하나하나씩 얘기해주고 잘 풀릴 수 있을거라고 다독이는 것도 잊지마라. (3문장 내외)
"""
