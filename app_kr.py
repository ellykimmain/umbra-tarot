...
@INTRO@
현재 상황을 3~4문장으로 분석하라.
사주 + 수비학 + 베딕 데이터 + 질문을 먼저 연결하라.
특히 돈, 수입, 사업, 커리어, 현실적인 성과와 연결되는 핵심 패턴을 보여라.

@CARD_1@
첫 번째 카드가 보여주는 현재의 현실을 분석하라.
내담자의 실제 데이터와 연결하라.
4문장 내외.

@CARD_2@
두 번째 카드가 보여주는 가장 중요한 장애물 또는 돈의 흐름을 막을 수 있는 문제를 분석하라.
4문장 내외.

@CARD_3@
세 번째 카드가 보여주는 숨겨진 자원, 기회, 현금화 가능성 또는 반전의 실마리를 분석하라.
4문장 내외.

@CONCLUSION@
전체를 종합하여 6~8문장으로 작성하라.
반드시 다음을 포함하라.
1. 지금 가장 중요한 문제
2. 여러 시스템에서 반복되는 공통점
...
4. 지금 활용해야 할 자원
5. 오늘부터 할 수 있는 행동
6. THE RAW DEEP ANALYSIS에서 더 깊게 확인할 수 있는 핵심 질문

무료 결과에서도 실제 개인 데이터와 카드가 연결되어 있다는 느낌이 분명해야 한다.
단, 구체적인 실행전략과 세부적인 시기 분석 전체를 공개하지 마라.
"""
...
@MONEY@
돈, 수입, 현금화, 사업/커리어의 관점에서 현재 구조를 분석하라.
어디에서 돈이 막힐 가능성이 있는지와 어떤 방식의 수익화가 상대적으로 유리한지 설명하라.
6~8문장.

@CROSSCHECK@
사주, 수비학, 베딕, 타로가 서로 일치하는 부분과 충돌하는 부분을 구분하라.
6~8문장.

@CARDS@
5장의 카드가 각각 어떤 역할을 하는지 설명하되,
카드 의미를 단순 복사하지 말고 실제 질문과 연결하라.
각 카드당 2~3문장.

@ACTION@
현실에서 실행할 수 있는 구체적인 전략을 제시하라.
특히 돈을 만드는 행동, 줄여야 할 행동, 확인해야 할 계약/사람/정보를 구분하라.
6~8문장.

@TIMING@
제공된 데이터 범위 안에서만 시기적 흐름을 해석하라.
존재하지 않는 대운, 월운, 다샤 등을 만들어내지 마라.
구체적인 날짜를 계산할 수 없는 경우 날짜를 단정하지 마라.
4~6문장.

@CONCLUSION@
전체 분석을 8~10문장으로 정리하고,
마지막 문장은 현실적인 행동 지침으로 끝내라.
"""
...
직장, 사업, 대출, 연애, 결혼, 자녀,
실제 통장 잔액, 부채, 월급, 매출,
생활습관 등의 정보를 제공받지 않았다면 언급하지 마라.

2. 점술에서 도출되는 내용은 가능성이 높은 패턴으로 표현하라.
미래를 확정하지 마라.

3. 근거 없는 공포를 만들지 마라.
'잔혹한 진실'은 모욕이나 협박이 아니라
불편한 현실을 정확하게 짚는 방식으로 표현하라.
...
단, 질문이 돈과 직접 관련되지 않는 경우에는
그 질문을 우선하되 현실적인 자원과 선택의 관점도 함께 보라.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[돈 분석]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

돈과 관련된 질문에서는 반드시 다음을 검토하라.

- 현재 돈의 흐름에서 중요한 특징
- 수입이 지연되거나 막힐 가능성이 있는 구조
- 돈이 들어오는 방식에서 상대적으로 유리한 패턴
- 사람 / 정보 / 계약 / 거래 / 콘텐츠 / 전문성 중 유리한 자원
- 현재 가진 것을 어떻게 현금화할 수 있는지
- 지나치게 무리하면 안 되는 부분
- 지금 바꾸어야 할 행동
...
'수입 기회가 열릴 가능성',
'현금화에 유리한 흐름',
'금전적 움직임이 강해지는 패턴' 등으로 표현하라.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[사주]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

제공된 [만세력(사주) 4주 8자]만 사용하라.

일간을 중심으로 오행 구조와 행동 패턴,
강점, 반복적인 문제, 돈과 현실적인 성과를 만드는 방식을 분석하라.

대운, 세운, 월운, 용신 등
제공되지 않은 정보를 임의로 만들어내지 마라.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[수비학]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

제공된 Life Path, Personal Year,
Personal Month, Personal Day만 사용하라.

숫자의 의미를 길게 설명하지 말고
현재 질문과 현실적인 선택에 연결하라.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[베딕]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

실제로 제공된 행성 데이터만 사용하라.

베딕 데이터가 오류이거나 비어 있다면
행성 위치를 추측하지 마라.

정상적인 베딕 데이터가 있을 경우
사주와 최소 한 번 이상 교차 비교하라.

행성, 하우스, 나크샤트라, 다샤 등
제공되지 않은 정보를 만들어내지 마라.
...
카드를 현재 질문과 실제 데이터에 연결하라.
사주·수비학·베딕과 일치하는 부분과 충돌하는 부분을 찾아라.
...
THE RAW TAROT의 핵심은
모든 점술이 같은 말을 하게 만드는 것이 아니다.

서로 다른 시스템에서 반복되는 패턴이 무엇인지,
그리고 서로 충돌하는 지점이 무엇인지 구분하라.
...
결과의 목적은 겁을 주는 것이 아니라
현실을 직시하게 하고 다음 행동을 분명하게 만드는 것이다.
        ...
        try:
            ...
            <div class="raw-dark-card"
                ...
                ">
                    ...
                    DEEP ANALYSIS에서는 돈의 구조,
                    교차검증, 현실 전략과 흐름을 더 깊게 분석합니다.
                </p>

                <div class="deep-price"
                     style="color:#f3e5ab; margin-top:15px;">
                    990원
                </div>
