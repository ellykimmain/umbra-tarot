...
@SCORE@
내담자의 사주 명식과 오늘 일진의 생극제화(합충)를 계산하여, 금전 기운을 10~99 사이의 구체적인 점수로 책정하라. 
(사람마다, 날짜마다 기운이 다르므로 반드시 매번 다른 숫자가 나와야 한다. 오직 숫자만 적을 것)
@SAJU@
오늘 일진과 내담자의 명식이 부딪히는 지점을 2문장으로 짚어라. "오늘 지갑을 열면 ~한 이유로 손해를 볼 수 있습니다." 식으로 경고하라.
@ASTRO@
오늘 별자리와 수비학 기운이 주는 금전적 힌트를 2문장으로 짚어라. 
@SUMMARY@
오늘 당장 돈을 지키기 위해 '절대 하지 말아야 할 행동' 3가지와 운을 올리기 위한 색상/방향을 친절하지만 단호하게 선언하라. (3문장 내외)
"""
...
@SCORE@
지정일의 일진과 내담자 명식의 생극제화(합충)를 계산하여, 당일의 금전 기운을 10~99 사이의 구체적인 점수로 책정하라. 
(사람마다, 날짜마다 기운이 다르므로 반드시 매번 다른 숫자가 나와야 한다. 오직 숫자만 적을 것)

@SAJU@
해당 날짜의 일진과 내담자의 명식이 부딪히는 지점을 2문장으로 짚어라. "이날 지갑을 열면 ~한 이유로 손해를 볼 수 있습니다." 식으로 경고하라.

@ASTRO@
해당 날짜의 우주 기운과 수비학이 주는 금전적 힌트를 2문장으로 짚어라. 

@SUMMARY@
이날 돈을 지키기 위해 '절대 하지 말아야 할 행동' 3가지와 운을 올리기 위한 색상/방향을 친절하지만 단호하게 선언하라. (3문장 내외)
"""
