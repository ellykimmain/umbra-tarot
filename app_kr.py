    ...
    if reading_mode.startswith("RAW CHAT"):
        ...
        if not st.session_state["chat_initialized"]:
            ...
            if user_input := st.chat_input("오라클에게 추가로 따져묻거나 질문하세요..."):
                ...
                [절대 철칙 및 필수 지침]
                1. 일반적인 심리 상담, 위로, 그리고 "형사 처벌을 무효화한다", "변호사를 써라" 같은 비현실적이거나 구체적인 법률적/현실적 치트키 솔루션을 '단 한 글자도' 말하지 마라.
                2. [SYSTEM ALERT ...] 같은 불필요한 메타 경고문이나 연극적 시스템 문구를 절대 생성하지 마라.
                3. 모든 진단은 오직 사주 명식(합충, 오행)과 베딕 점성술(행성, 하우스)의 구조적 원리 안에서만 해석하라.
                4. 절망만 주지 말고, "잠깐, 명식의 다른 궤도(예: 지지의 합충이나 하우스의 흐름)를 보면 이 압박을 돌파할 또 다른 역학적 단서가 숨어 있다"는 뉘앙스를 풍겨라.
                5. 분량은 기존의 절반으로 짧고 압축적으로 작성하고, 마지막은 다음 실마리를 파볼 것인지 묻는 질문 1개로 끝낼 것.
                6. 형사처럼, 고소, 고발 등과 같은 법적인 것을 마지막에 연결하려 하지마라. 
                ```
